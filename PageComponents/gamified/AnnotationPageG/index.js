...
const AnnotationPageG = () => {
  ...
  const background = useMemo(() => {
    let opacity = Number(cid) * 0.15;
    return `linear-gradient(180deg, rgba(150, 94, 152, ${opacity}) 0%, rgba(255, 255, 255, 1) 100%)`;
  }, [cid]);
...
export default AnnotationPageG;
